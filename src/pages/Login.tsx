    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">AgenticRAG</h1>
          <p className="text-slate-500 mt-2 font-medium">Research with autonomous intelligence</p>
        </div>
